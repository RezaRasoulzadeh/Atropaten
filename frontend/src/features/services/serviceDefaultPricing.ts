...
function formFromService(service: ServiceRecord): ServiceForm {
  ...
  return {
    ...
    defaultOutsourcedCostInput: service.defaultOutsourcedCostRial ? String(service.defaultOutsourcedCostRial) : '',
    defaultOutsourcedShippingRial: service.defaultOutsourcedShippingRial || 0,
    defaultOutsourcedShippingInput: service.defaultOutsourcedShippingRial ? String(service.defaultOutsourcedShippingRial) : '',
    parameters,
    components,
    pricingRule,
