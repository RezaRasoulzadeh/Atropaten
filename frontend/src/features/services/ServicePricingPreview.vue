...
const methodLabel = computed(() => ({ markup: 'Markup', 'fixed-margin': 'Fixed margin', fixed: 'Fixed price', 'quantity-tiers': 'Quantity tiers', variation: 'Variation prices', 'per-unit': 'Per-unit rate', manual: 'Manual price' }[props.pricingRule.type] || 'Pricing'))
</script>
