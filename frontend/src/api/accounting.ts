...
export interface PaymentPayload {
  ...
  amountRial: number
  allocations: { targetType: string; targetId: string; amountRial: number }[]
}
...
export const accountingApi = {
  accounts() {
    return ListAccounts() as unknown as Promise<AccountRecord[]>
  },
  financialAccounts() {
  ...
  payments() {
    return ListPayments() as unknown as Promise<PaymentRecord[]>
  },
  createPayment(v: PaymentPayload) {
    return CreatePayment(v as any) as unknown as Promise<PaymentRecord>
  },
  reversePayment(id: string, key = '') {
    return ReversePayment(id, key) as unknown as Promise<PaymentRecord>
  },
  expenses() {
    return ListExpenses() as unknown as Promise<ExpenseRecord[]>
  },
  createExpense(v: ExpensePayload) {
    return CreateExpense(v as any) as unknown as Promise<ExpenseRecord>
  },
  ...
  createTransfer(v: TransferPayload) {
    return CreateTransfer(v as any) as unknown as Promise<TransferRecord>
  },
  reverseTransfer(id: string, key = '') {
    return ReverseTransfer(id, key) as unknown as Promise<TransferRecord>
  },
}
