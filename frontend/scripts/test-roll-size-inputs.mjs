...
const { ensureRollSizeInputs, materialOptionsForParameter, usesMaterialRollWidth, selectedRollMaterial, rollWidthValue } = await import(`data:text/javascript;base64,${Buffer.from(js).toString('base64')}`)
